...
public class Settings extends Fragment {
    ...
    TextView tvUser, personalInformation;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        tvUser.setText(SaveSharedPreferences.getUserName(getContext()));
        personalInformation = getView().findViewById(R.id.tvPersonalInformation);
